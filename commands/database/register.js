    ...
    async execute(client, message, args, cmd, Discord /*, Users */) {
        ...
        //For reregister
            ...
            if(users === null){
                ...
                return message.channel.send({ embeds: [reregisteredembed] })
            }
        }
        //For account delete
            ...
            if(users === null){
                ...
                return message.channel.send({ embeds: [deletedembed] })
            }
        ...
        //For profile
            ...
            if(users === null){
                ...
                .setTimestamp()
                return message.channel.send({ embeds: [profilembed] })
            }
        }
        //other user profile
            ...
            if(!message.mentions.users.first()) {
                ...
                return message.channel.send({ embeds: [thereisno] })
            }
        ...
        //For profile options
            ...
            if(args[0] === `desc`){
                if(users === null){
                    ...
                    if(customdesc.length > 100){
                        ...
                        return message.channel.send({ embeds: [morelengthembed] })
                    }
            ...
            //For profile options embed
                ...
                message.channel.send({ embeds: [profileoptions] })
            }
        }
        //For money
